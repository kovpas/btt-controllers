...
##### locale-service runner #####
widget_uuid='1ACB5923-24B5-4EB9-8A7C-BBB2F89082F4'

status_directory="${btt_sys_root}/locale-service"
status_filepath="${status_directory}/status"
service_cli_filepath="${btt_usr_root}/locale/locale-service"
...
# widget_uuid='5AD4BE9B-AAA2-43FC-8735-48914958A018'
